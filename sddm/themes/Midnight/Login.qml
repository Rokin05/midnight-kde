    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "#6c6f7b"
            selectedTextColor: "#6c6f7b"        // The highlighted text color
            selectionColor: "#111418"          // The text highlight color
            placeholderTextColor:"#6c6f7b"    // When the text field is empty
    ...
    PlasmaComponents.Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                ...
                radius: 2
                gradient: Gradient {
                    GradientStop { position: 0 ; color: control.pressed ? "#22252f" : "#232631" }
                    GradientStop { position: 1 ; color: control.pressed ? "#21242d" : "#21242d" }
                }
                //implicitWidth: 100
                implicitHeight: 25
            }
